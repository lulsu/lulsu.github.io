...
function classiferHandler(error,results) {
  ...
  if (result=='car'&&check==100) {
    ...
    audio.play();
    check=0;
  }  else if (result=='trash'&&check==100) {
    ...
    audio.play();
    check=0;
  }  else if (result=='building'&&check==100) {
    ...
    audio.play();
    check=0;
  }  else if (result=='green'&&check==100) {
    ...
    audio.play();
    check=0;
  }  else if (result=='human'&&check==100) {
